...
face_classifier = cv2.CascadeClassifier(r"D:\NIT_DATA_SCIENCE\Deep_Learing\computer_vision_opencv2\haarcascade_frontalface_default.xml")# Load the image
image = cv2.imread(r"D:\NIT_DATA_SCIENCE\Deep_Learing\computer_vision_opencv2\photo.jpeg")
